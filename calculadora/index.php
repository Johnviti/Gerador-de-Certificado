...
if ($_POST) {
    ...
    $valorMediacao = $_REQUEST['txtValor']; 
    $taxaRegistro = $_REQUEST['taxa'];     
    $qtdHoras = $_REQUEST['horas']; 
    ...
    <div>
      ...
      <div class="container-form-mediacao">
        <div class="">
          ...
          <form action="" method="POST" style="display: flex;align-content: flex-end;align-items: flex-end;">
            <p>Valor da Mediação:
              <input type="text" placeholder="R$ 0,00" id="txtValor" name="txtValor" class="campo" data-thousands="." data-decimal="," data-prefix="R$ " value="<?php echo $_REQUEST['txtValor']; ?>" required /><br></p>
            <p>Taxa de Registro:
              <input type="text" placeholder="R$ 0,00" id="taxa" name="taxa" class="campo" data-thousands="." data-decimal="," data-prefix="R$ " value="<?php echo $_REQUEST['taxa']; ?>" required /><br>
            </p>
            <p>Quantidade de horas:
              <input type="text" placeholder="R$ 0,00" id="horas" name="horas" class="campo" data-thousands="." data-decimal="," data-prefix="R$ " value="<?php echo $_REQUEST['horas']; ?>" required /><br>
            </p>
            <input type="submit" id="cmdCalcular20173" value="Calcular" class="botao" style="border-radius: 25px; border-color: #90c445; display: block; margin: 10px;" />
          </form>
        </div>
      </div>
        ...
        <div class="grupo-custas">
            ...
            <div class="tabela">
              ...
              <div class="linha">
                <div class="coluna">---</div>
                <div class="coluna"><span id="lblRequerenteTaxaRegistro2"><?php echo $horasExcedentesvalor ?></span></div>
                <div class="coluna"><span id="lblRequerenteTaxaRegistro2"><?php echo $msgHorasExcedentes ?></span></div>
              </div>
              <div class="linha">
                <div class="coluna">Taxa de administração</div>
                <div class="coluna"><span id="lblRequerenteTaxaRegistro2"><?php echo "R$" . number_format($taxaAdm, 2, ',', '.')  ?></span></div>
                <div class="coluna"><span id="lblRequerenteTaxaRegistro2"><?php echo "R$" . number_format($taxaAdm, 2, ',', '.')  ?></span></div>
              </div>
              <div class="linha">
                <div class="coluna">Honorários</div>
                <div class="coluna"><span id="lblRequerenteTaxaAdministracao2"><?php echo "R$" . number_format($honorario, 2, ',', '.')  ?></span></div>
                <div class="coluna"><span id="lblRequeridoTaxaAdministracao2"><?php echo "R$" . number_format($honorario, 2, ',', '.')  ?></span></div>
              </div>
              <div class="linha">
                <div class="coluna">Horas Excedentes</div>
                <div class="coluna"><span id="lblRequerenteHonorarioArbitros2"><?php echo "R$" . number_format($valorHorasAdicionais, 2, ',', '.')  ?></span></div>
                <div class="coluna"><span id="lblRequeridoHonorarioArbitros2"><?php echo "R$" . number_format($valorHorasAdicionais, 2, ',', '.')  ?></span></div>
              </div>
              <div class="linha total">
                <div class="coluna ">Totais</div>
                <div class="coluna"><span id="lblRequerenteTotal2"> <?php echo "R$" . number_format($totalSolicitantes, 2, ',', '.')?> </span></div>
                <div class="coluna"><span id="lblRequeridoTotal2"><?php echo "R$ " .  number_format($totalSolicitada, 2, ',', '.')?></span></div>
              </div>
            </div>
        </div>
    </div>
